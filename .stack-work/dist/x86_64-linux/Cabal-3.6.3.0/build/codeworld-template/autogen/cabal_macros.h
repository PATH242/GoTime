...
/* package codeworld-template-0.0.0 */
#ifndef VERSION_codeworld_template
#define VERSION_codeworld_template "0.0.0"
#endif /* VERSION_codeworld_template */
#ifndef MIN_VERSION_codeworld_template
#define MIN_VERSION_codeworld_template(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  0 || \
  (major1) == 0 && (major2) == 0 && (minor) <= 0)
#endif /* MIN_VERSION_codeworld_template */
...
#define CURRENT_COMPONENT_ID "codeworld-template-0.0.0-2gQWLn9qi2d7IdkNr8fCaU-codeworld-template"
